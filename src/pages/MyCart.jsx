...
export default function MyCart() {
  ...
  return (
    <section className="p-8 flex flex-col">
      ...
      {hasProducts && (
        <>
          <ul className="border-b border-gray-300 mb-8 p-4 px-8">{products && products.map((product) => <CartItem key={product.id} product={product} uid={uid} />)}</ul>
          <div className="flex justify-between items-center mb-6 p-2 md:p-8 lg:px-16">
